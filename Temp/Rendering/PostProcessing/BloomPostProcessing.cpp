...
BloomPostProcessing::BloomPostProcessing(vec2 FinalOutputDimensions) : PostProcessingLayer("Bloom", FinalOutputDimensions) {
	S_ClipHDRShader = new Shader("./Res/Shaders/PostProcessing/Bloom/ClipHDR.frag", "Res/Shaders/PostProcessing/Bloom/ClipHDR.vert");
	S_BlendBloom = new Shader("./Res/Shaders/PostProcessing/Bloom/BlendBloom.frag", "./Res/Shaders/PostProcessing/Bloom/BlendBloom.vert");
