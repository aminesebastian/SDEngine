...
VariableGausianBlur::VariableGausianBlur(vec2 RenderTargetResolution) {
	...
	S_GBlur5x1 = new Shader("./Res/Shaders/PostProcessing/GBlur5x1.frag", "./Res/Shaders/PostProcessing/GBlur5x1.vert");
	S_BlurBlend = new Shader("./Res/Shaders/PostProcessing/BlendGausBlur.frag", "./Res/Shaders/PostProcessing/BlendGausBlur.vert");
}
