...
EditorSpriteComponent::EditorSpriteComponent(const TString& Name, const TString& TexturePath, vec3 Color) : EditorSpriteComponent(Name, new Texture2D(TexturePath), Color) { }
