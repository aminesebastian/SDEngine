...
RenderViewport::RenderViewport(vec2 RenderTargetDimensions) : RenderTargetDimensions(RenderTargetDimensions) {
	...
	S_TranslucencyBlendShader = new Shader("./Res/Shaders/TranslucencyCompositor.frag", "./Res/Shaders/TranslucencyCompositor.vert");
	SelectionOutlineShader    = new Shader("./Res/Shaders/SelectionOutlineShader.frag", "./Res/Shaders/TranslucencyCompositor.vert");
	S_GBuffer                 = nullptr;
