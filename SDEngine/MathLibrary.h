...
public:
	...
	static bool LineTraceAgainstWorldFromScreen(FHitInfo& HitInfo, vec2 MouseCoordinates, Camera* Camera, UWorld* World);
	static bool LineTraceAgainstWorld(FHitInfo& HitInfo, UWorld* World, vec3 RayOrigin, vec3 RayDirection);
	/**
