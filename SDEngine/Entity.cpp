...
Entity::Entity(TString Name) : S_Name(Name), S_AABB(nullptr), S_World(nullptr) {}
Entity::~Entity() {};
...
bool Entity::TraceAgainstRay(vec3 Origin, vec3 Direction, vec3& HitPoint, float& Distance) {
	return false;
}

FAABB* Entity::GetAxisAlignedBoundingBox() { return S_AABB; }
