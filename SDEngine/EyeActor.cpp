...
EyeActor::EyeActor(const Transform SpawnTransform) :
	Actor(SpawnTransform) {
	...
	S_InnerEye = new StaticMesh(SpawnTransform, S_InnerEyeMaterial, "./res/Eye/Eye.fbx");
	...
	S_OuterEye = new StaticMesh(SpawnTransform, S_OuterEyeMaterial, "./res/Eye/EyeClear.fbx");
}
EyeActor::~EyeActor() {
}
